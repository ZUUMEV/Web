...
const contactCards = [
  ...
  },
  {
    ...
    action: 'Send Email',
    href: 'mailto:info@zuum.co.in',
    icon: Mail,
    accent: 'bg-primary text-primary-foreground',
    accentLight: 'bg-primary/15 text-primary',
    label: 'info@zuum.co.in',
    external: false,
  },
]
      ...
      <section className="mt-12 grid gap-5 sm:grid-cols-2">
        <div className="rounded-2xl border border-border bg-card/40 p-6">
          ...
          <ul className="mt-3 space-y-1.5 text-sm text-muted-foreground">
            <li className="flex justify-between"><span>Monday &ndash; Friday</span><span>9:00 AM &ndash; 9:00 PM</span></li>
            <li className="flex justify-between"><span>Saturday</span><span>9:00 AM &ndash; 9:00 PM</span></li>
            <li className="flex justify-between"><span>Sunday</span><span>9:00 AM &ndash; 9:00 PM</span></li>
