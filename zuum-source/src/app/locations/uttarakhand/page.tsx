  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <section className="mt-12 rounded-2xl bg-gradient-to-br from-primary to-primary/80 p-8 text-center text-primary-foreground">
        <h2 className="text-2xl font-bold sm:text-3xl">Ready to Start Earning in Uttarakhand?</h2>
        <p className="mx-auto mt-3 max-w-xl text-sm text-primary-foreground/90 sm:text-base">
          Join 75+ delivery partners already earning ₹35,000+/month with ZUUM. Apply on WhatsApp — get a scooter assigned within 24 hours.
        </p>
